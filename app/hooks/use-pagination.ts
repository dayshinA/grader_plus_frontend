...
/** Derives the page-number range to render around `currentPage`, with ellipsis flags for the
 * gaps at either end. Pure computation, no internal state — the caller owns `currentPage`. */
