...
export function DepartmentAdminGrantsPage() {
  ...
  const {
    ...
    isError,
    error,
  } = useDepartmentAdminGrants(departmentId ?? undefined);
    ...
    <div className="flex flex-col gap-4">
      ...
      {!departmentId || departmentNotFound ? (
        <div className="flex h-40 items-center justify-center rounded-lg border border-dashed border-border text-sm text-muted-foreground">
          Select a department to view and manage its Department Admins.
        </div>
      ) : (
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu modal={false}>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onSelect={() =>
                                setToggleTarget({ ...grant, coordinatorName })
                              }
                            >
